 ...
 *   ├─────────────────────────────────────────┤
 *   │  Title     [113-2 Semester Spring____]  │
 *   │  ─────────────────────────────────────  │
 *   │  Start     [  DatePicker  ▾           ] │
 *   │  ─────────────────────────────────────  │
 *   │  End       [  DatePicker  ▾           ] │
 ...
 *
 * Save flow:
 *   Validates title + date range → calls ctrl.saveNewTimetable(title, start, end)
 *   Controller appends to timetableList, sets it active, navigates back to Panel 3.
 */
public class TimetableCreatePane extends VBox {
    ...
    public TimetableCreatePane(DashboardController ctrl) {
        ...
        // Sensible defaults: current month to +5 months
